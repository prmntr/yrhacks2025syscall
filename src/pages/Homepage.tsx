function Homepage() {
  ...
  <section className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-12 border border-gray-700 rounded-2xl p-6 bg-gray-800 shadow-md">
    ...
    <div className="w-full md:w-1/2 space-y-6">
      ...
      <p>
      We leverage cutting-edge technology to provide personalized dashboards, track progress, and enhance learning experiences.      </p>
    </div>
  </section>
  ...
  <section className="border border-gray-700 rounded-2xl p-6 bg-gray-800 shadow-md">
    ...
    <p>
    At Tutorly, we aim to bridge the gap between students and the academic support they need. We understand the challenges many students face in finding help, especially from personal experience working with ESL learners. Our mission is to make it easier for tutors and tutees to connect, enabling students to access the assistance they need, whenever and wherever they need it. Through our unique tag system, we ensure that every student can find the precise help they’re looking for. At Tutorly, our goal is simple: to support our fellow students by making tutoring accessible and effective for everyone.    </p>
  </section>
